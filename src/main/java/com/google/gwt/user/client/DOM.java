 ...
 * both {@link com.google.gwt.dom.client.Element elements} and {@link com.google.gwt.dom.client.Event events}.
 */
public class DOM {
	 ...
	 * <p>
	 * If the child element is a {@link com.google.gwt.user.client.ui.PotentialElement}, it is first resolved.
	 * </p>
	 *
	 * @param parent
	 *           the parent element
	 ...
	 * @param evt
	 *           the event to be tested
	 * @return a bit-field, defined by {@link Event#BUTTON_LEFT}, {@link Event#BUTTON_MIDDLE}, and {@link Event#BUTTON_RIGHT}
	 */
	...
	/**
	 * Gets the element from which the mouse pointer was moved (valid for {@link Event#ONMOUSEOVER} and {@link Event#ONMOUSEOUT}).
	 * 
	 * @param evt
	 *           the event to be tested
	 ...
	 * 
	 * <p>
	 * For {@link Event#ONKEYPRESS}, this method returns the Unicode value of the character generated. For {@link Event#ONKEYDOWN} and {@link Event#ONKEYUP}, it returns the code associated with the physical key.
	 * </p>
	 * 
	 * @param evt
	 *           the event to be tested
	...
	/**
	 * Gets the element to which the mouse pointer was moved (only valid for {@link Event#ONMOUSEOUT} and {@link Event#ONMOUSEOVER}).
	 * 
	 * @param evt
	 *           the event to be tested
    ...
    return parent.getChildElements().get(index);
  }
	...
	/**
	 * Gets the src attribute of an img element. This method is paired with {@link #setImgSrc(Element, String)} so that it always returns the correct
	 * url.
	 * 
	 * @param img
	 ...
	 * @param before
	 *           an existing child element of <code>parent</code> before which <code>child</code> will be inserted
	 * @see com.google.gwt.user.client.ui.PotentialElement#resolve(Element)
	 */
	 ...
	 * @param value
	 *           the <code>value</code> attribute for the new <code>&lt;option&gt;</code>; cannot be <code>null</code>
	 * @param index
	 ...
	 * @deprecated use {@link com.google.gwt.event.shared.HandlerRegistration} returned from {@link Event#addNativePreviewHandler(Event.NativePreviewHandler)}
	 */
	@Deprecated
	...
	/**
	 * Sinks a named event. Events will be fired to the nearest {@link EventListener} specified on any of the element's parents.
	 * 
	 * @param elem
	 *           the element whose events are to be retrieved
	 * @param eventTypeName
