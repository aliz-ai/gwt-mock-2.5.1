...
public class RichTextAreaImplIE6 extends RichTextAreaImplStandard {
  ...
  public native void insertHTML(String html) /*-{
    try {
      ...
      if (!@com.google.gwt.dom.client.DOM::isOrHasChild(Lcom/google/gwt/user/client/Element;Lcom/google/gwt/user/client/Element;)(doc.body, tr.parentElement())) {
        return;
      }
      tr.pasteHTML(html);
    }
    ...
    var handler = $entry(function(evt) {
      if (elem.__listener) {
        if (@com.google.gwt.user.client.impl.DOMImpl::isMyListener(Ljava/lang/Object;)(elem.__listener)) {
          ...
          @com.google.gwt.dom.client.DOM::dispatchEvent(Lcom/google/gwt/user/client/Event;Lcom/google/gwt/user/client/Element;Lcom/google/gwt/user/client/EventListener;)(evt, elem, elem.__listener);
        }
      }
    });
