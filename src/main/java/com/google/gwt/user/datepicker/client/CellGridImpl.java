...
abstract class CellGridImpl<V> extends Grid {
  ...
  public Cell getCell(Element element) {
    ...
    return elementToCell.get((com.google.gwt.dom.client.Element) element);
  }
  ...
  public Cell getCell(Event e) {
    ...
    return td != null
        ? elementToCell.get((com.google.gwt.dom.client.Element) td) : null;
  }
  ...
  public void onBrowserEvent(Event event) {
    switch (DOM.eventGetType(event)) {
      ...
      case Event.ONMOUSEOUT: {
        ...
        if (e != null) {
          Cell cell = elementToCell.get((com.google.gwt.dom.client.Element) e);
