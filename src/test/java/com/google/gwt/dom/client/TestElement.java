...
public class TestElement {
	...
	public void testInnerHTMLSimpleText() {
		...
		Assert.assertEquals("<div className=\"gwt-Label\">changed inner html</div>", Document.get().getBody().getInnerHTML().replaceAll("[\\r\\n]", ""));
	}
	...
	public void testInnerHTMLOfComposite() {
		...
		Assert.assertEquals("<div>  <div className=\"gwt-Label\">one  </div>" + //
				"  <div className=\"gwt-Label\">two  </div></div>", Document.get().getBody().getInnerHTML().replaceAll("[\\r\\n]", ""));
	}
	...
	public void testInnerHTMLWithInnerElement() {
		...
		Assert.assertEquals("changed <div>inner</div> html", element.getInnerHTML().replaceAll("[\\r\\n]", ""));
	}
	...
	public void testInnerHTMLWithComplexInnerElements() {
		...
		Assert.assertEquals("L1.1<div>L2.1  <div>L3.1  </div>L2.2  <div>L3.2  </div>L2.3</div>L1.2", element.getInnerHTML().replaceAll("[\\r\\n]", ""));
	}
	...
	public void testToString() {
		...
		Assert.assertEquals("hello world", element.getInnerHTML());
		Assert.assertEquals("<div className=\"gwt-Label\">hello world</div>", element.toString().replaceAll("[\\r\\n]", ""));
	}
}
